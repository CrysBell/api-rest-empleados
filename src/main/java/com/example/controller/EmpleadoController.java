...
public class EmpleadoController {
    ...
    public ResponseEntity<Map<String, Object>> findEmpleadoById(
        ...
        try {
            ...
            if (empleado != null) {
                String successMessage = "mensaje todo OK " + empleado_id + " ha sido encontrado";
                
                responseAsMap.put("successMessage", successMessage);
                responseAsMap.put("empleado encontrado", empleado);
                responseEntity = new ResponseEntity<Map<String,Object>>(responseAsMap, HttpStatus.OK);
            }
            else{
                String failureMessage = "No ha sido encontrado ningun empleado con id: "
                + empleado_id;
            ...
            + empleado_id + ", y la causa mas probable es: " + e.getMostSpecificCause().getMessage();
